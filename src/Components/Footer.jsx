    ...
    <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden' id='Footer'>
        <div className='flex container mx-auto flex-col md:flex-row justify-between items-center'>
            <div className='w-full md:w-1/3 mb-8 md:mb-0'>
                ...
                <p className='text-gray-400 mt-4'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Recusandae commodi pariatur est, ipsam quos quod nisi dolor, reiciendis necessitatibus doloremque ab vero! Placeat odio magni, modi nisi recusandae voluptas blanditiis.</p>
            </div>
